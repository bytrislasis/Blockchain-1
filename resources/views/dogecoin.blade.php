        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('dogecoinUnlock')}}" method="POST">
                            @csrf
                            <div class="row">
                ...
                <div class="card mt-3">
                    <div class="card-header"><i class="fa-solid fa-dog"></i> {{strtoupper(\Request()->route()->getName())}} Cüzdanı</div>
                    <div class="card-body">
                        <div class="card-text">
                            ...
                            @if($kontrol == null)
                                <span class="fw-bold"><a href="{{route('dogecoinAdressOlustur')}}" class="btn btn-primary">Adres Oluştur</a></span>
                            @else
                    ...
                    <div class="card-footer">
                        <form action="{{route('dogecoinCek')}}" method="POST">
                            @csrf
                            <div class="row">
